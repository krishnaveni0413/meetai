...
const formSchema =z.object({
    ...
    ConformPassword: z.string().min(1, {message: "Password is required"}),
})
    ...
    return (
        ...
        <div className="flex flex-col gap-6">
            <Card className="overflow-hidden p-0">
                <CardContent className="grid p-0 gap-2 md:grid-cols-2">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className='p-6 md:p-8'>
                            <div className='flex flex-col gap-6'>
                                ...
                                <div className='grid gap-3'>
                                    ...
                                    render={({field})=>(
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type='text' placeholder='John Deo' {...field}/>
                                            </FormControl>
                                            <FormMessage/>
                                        </FormItem>
                                    )}/>
                                ...
                                <div className='text-center text-sm'>
                                    Already have an account?{" "} <Link href='/sign-in' className='underline-set-4 underline '>Sign In</Link>
